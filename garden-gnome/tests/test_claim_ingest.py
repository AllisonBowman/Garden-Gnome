...
def test_the_whole_verified_tranche_lands_and_resolves(session):
    ...
    # + 27 (b51) = 2297. + 25 (b52) = 2322. + 27 (b53) = 2349. + 23 (b54) = 2372. + 20 (b55) = 2392. b18 was the
    ...
    # an open follow-up, flagged in its toxicity_detail). Every
    ...
    # that pass caught.
    assert report.claims_written == 2392

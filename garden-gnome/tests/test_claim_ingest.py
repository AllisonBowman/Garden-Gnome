...
def test_the_whole_verified_tranche_lands_and_resolves(session):
    ...
    # + 27 (b51) = 2297. + 25 (b52) = 2322. + 27 (b53) = 2349. + 23 (b54) = 2372. + 20 (b55) = 2392. + 24 (b56) = 2416. + 21 (b57) = 2437. + 18 (b58) = 2455. + 17 (b59) = 2472. + 27 (b60) = 2499. + 21 (b61) = 2520. b18 was the
    ...
    # Honeysuckle, and Lowbush Blueberry). Every
    ...
    # that pass caught.
    assert report.claims_written == 2520

...
def test_the_whole_verified_tranche_lands_and_resolves(session):
    ...
    # + 27 (b51) = 2297. + 25 (b52) = 2322. + 27 (b53) = 2349. + 23 (b54) = 2372. + 20 (b55) = 2392. + 24 (b56) = 2416. + 21 (b57) = 2437. + 18 (b58) = 2455. + 17 (b59) = 2472. + 27 (b60) = 2499. + 21 (b61) = 2520. + 23 (b62) = 2543. + 25 (b63) = 2568. + 22 (b64) = 2590. + 27 (b65) = 2617. + 24 (b66) = 2641. + 23 (b67) = 2664. + 26 (b68) = 2690. + 19 (b69) = 2709. + 22 (b70) = 2731. + 24 (b71) = 2755. + 28 (b72) = 2783. + 24 (b73) = 2807. + 2 (toxic_to_pets verdict pass, 2026-09-10: Money Tree true, Red Maple false) = 2809. + 25 (b74) = 2834. + 27 (b75) = 2861. + 21 (b77) = 2882. + 31 (b78) = 2913. + 31 (b76) = 2944. + 32 (b79) = 2976. + 13 (b80) = 2989. + 34 (b83) = 3023. + 26 (b82) = 3049. b18 was the
    ...
    # Red Mulberry; b67 a fifth native tree set -- Moosewood, Downy Serviceberry,
    # American Crabapple, Staghorn Sumac, Black Willow, and Eastern Hemlock,
    # where two common names changed at landing on the audit's own
    # findings; b68 native vines and a rhododendron -- Trumpet Honeysuckle,
    ...
    # Dogwood, Water Tupelo, and Inkberry; b71 native ferns and a sedge --
    # Christmas Fern, Northern Maidenhair Fern, Ostrich Fern, Evergreen Wood
    # Fern, Sensitive Fern, and Pennsylvania Sedge, where one common name
    ...
    # that pass caught.
    assert report.claims_written == 3049

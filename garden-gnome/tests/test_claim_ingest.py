...
def test_the_whole_verified_tranche_lands_and_resolves(session):
    """End to end: 112 researched species become queryable, cited evidence."""
    ...
    # (b11) + 39 (b12) + 35 (b13) + 34 (b14) = 773. Batches land as part of
    # an ongoing /loop run over the remaining curated catalog; each one is
    ...
    # caught.
    assert report.claims_written == 773
